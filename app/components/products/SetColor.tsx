...
<div className="flex gap-4 items-center">
    ...
    {images.map((image)=>{
return (
<div key={image.color}  onClick={()=>handleColorSelect(image)} className={`h-7 w-7 rounded-full border-teal-300 flex items-center justify-center ${cartProduct.selectedImage.color===image.color ? 'border-[1.5px]' : 'border-none' }`}>
